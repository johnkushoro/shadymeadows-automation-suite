...
export class AuthenticationHelper {
   ...
   */
  public async authenticateWithOAuth(username: string, password: string): Promise<void> {
   ...
   */
  public async authenticateBasic(username: string, password: string): Promise<void> {
    // Fill username
    await this.actionHelper.fillInputByLabel('Username', username);
   ...
   */
  public async authenticateWithMicrosoft(username: string, password: string): Promise<void> {
   ...
   */
  public async authenticateWithGoogle(username: string, password: string): Promise<void> {
   ...
   */
  public async handleTwoFactorAuth(code: string): Promise<void> {
   ...
   */
  public async saveAuthSession(sessionName: string = 'auth-session'): Promise<void> {
   ...
   */
  public async loadAuthSession(sessionName: string = 'auth-session'): Promise<boolean> {
    try {
      ...
      if (sessionData) {
        ...
        await this.page.evaluate((storage) => {
          storage.origins.forEach((origin: any) => {
   ...
   */
  public async handleAuthError(): Promise<string | null> {
   ...
   */
  public async retryAuthentication(
    username: string, 
    password: string, 
    maxRetries: number = 3
  ): Promise<boolean> {
