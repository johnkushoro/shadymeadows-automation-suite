 ...
 */
export class CaseManagementPage extends BasePage {
   ...
   * Search for cases
   */
  public async searchCases(searchTerm: string): Promise<void> {
   ...
   */
  public async switchToKanbanView(): Promise<void> {
   ...
   * Create new case
   */
  public async clickCreateCase(): Promise<void> {
   ...
   * Fill case form
   */
  public async fillCaseForm(caseData: {
    title: string;
    description: string;
    caseType: string;
    client: string;
   ...
   */
  public async cancelCase(): Promise<void> {
   ...
   * View case details
   */
  public async viewCase(caseId: string): Promise<void> {
   ...
   * Edit case
   */
  public async editCase(caseId: string): Promise<void> {
    const row = this.locatorHelper.getContainingText('tr', caseId);
   ...
   * Assign case
   */
  public async assignCase(caseId: string): Promise<void> {
    const row = this.locatorHelper.getContainingText('tr', caseId);
   ...
   * Close case
   */
  public async closeCase(caseId: string): Promise<void> {
    const row = this.locatorHelper.getContainingText('tr', caseId);
   ...
   */
  public async dragCaseToColumn(caseTitle: string, targetColumn: string): Promise<void> {
   ...
   * Perform bulk assign
   */
  public async bulkAssign(advisor: string): Promise<void> {
   ...
   * Get case count
   */
  public async getCaseCount(): Promise<number> {
   ...
   * Get case status
   */
  public async getCaseStatus(caseId: string): Promise<string> {
    const row = this.locatorHelper.getContainingText('tr', caseId);
   ...
   * Export cases
   */
  public async exportCases(): Promise<void> {
   ...
   */
  public async getTotalCasesCount(): Promise<string> {
   ...
   */
  public async getOpenCasesCount(): Promise<string> {
