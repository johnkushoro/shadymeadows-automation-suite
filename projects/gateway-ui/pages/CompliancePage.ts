...
export class CompliancePage extends BasePage {
   ...
   */
  public async searchComplianceItems(searchTerm: string): Promise<void> {
   ...
   */
  public async clickCreateComplianceItem(): Promise<void> {
   ...
   */
  public async fillComplianceForm(complianceData: {
    title: string;
    description: string;
    type: string;
    priority: string;
   ...
   */
  public async saveComplianceItem(): Promise<void> {
   ...
   */
  public async cancelComplianceItem(): Promise<void> {
   ...
   */
  public async reviewComplianceItem(itemId: string, reviewData: {
    notes: string;
    status: string;
    reviewer: string;
    date: string;
   ...
   */
  public async approveComplianceItem(itemId: string): Promise<void> {
    const row = this.locatorHelper.getContainingText('tr', itemId);
   ...
   */
  public async rejectComplianceItem(itemId: string): Promise<void> {
    const row = this.locatorHelper.getContainingText('tr', itemId);
   ...
   */
  public async generateReport(reportData: {
    type: string;
    period: string;
    format: string;
  }): Promise<void> {
   ...
   */
  public async getComplianceScore(): Promise<string> {
   ...
   */
  public async getOverdueItemsCount(): Promise<string> {
   ...
   */
  public async getComplianceItemStatus(itemId: string): Promise<string> {
    const row = this.locatorHelper.getContainingText('tr', itemId);
   ...
   */
  public async exportComplianceData(): Promise<void> {
   ...
   */
  public async refreshComplianceList(): Promise<void> {
